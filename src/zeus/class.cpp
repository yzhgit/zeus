...
//
// File: class.cpp - Utilities and helpers for classes
//

#include <zeus/class.h>
 ...
 *
 * private:
 * 	ZEUS_DISABLE_COPY(NonCopyable)
 * };
 * \endcode
 */

/**
 * \def ZEUS_DISABLE_MOVE
 ...
 *
 * private:
 * 	ZEUS_DISABLE_MOVE(NonMoveable)
 * };
 * \endcode
 */

/**
 * \def ZEUS_DISABLE_COPY_AND_MOVE
 ...
 *
 * private:
 * 	ZEUS_DISABLE_COPY_AND_MOVE(NonCopyableNonMoveable)
 * };
 * \endcode
 */

/**
 * \def ZEUS_DECLARE_PRIVATE
 * \brief Declare private data for a public class
 *
 * The ZEUS_DECLARE_PRIVATE() macro plumbs the infrastructure necessary to
 * make a class manage its private data through a d-pointer. It shall be used at
 * the very top of the class definition.
 */

/**
 * \def ZEUS_DECLARE_PUBLIC
 * \brief Declare public data for a private class
 * \param klass The public class name
 *
 * The ZEUS_DECLARE_PUBLIC() macro is the counterpart of
 * ZEUS_DECLARE_PRIVATE() to be used in the private data class. It shall be
 ...
 * - invoke the ZEUS_DECLARE_PRIVATE() macro at the very top of the class
 *   definition
 * - define a private data class named PublicClass::Private that inherits from
 *   the Private data class of the base class
 * - invoke the ZEUS_DECLARE_PUBLIC() macro at the very top of the Private
 ...
 * functions of the Private class using the ZEUS_O_PTR() macro.
 */
 ...
 * derived from Extensible get, through the ZEUS_DECLARE_PRIVATE() macro,
