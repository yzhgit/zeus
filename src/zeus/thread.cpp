...
//
// File: thread.cpp - Thread support
//
...
#include <zeus/event_dispatcher_poll.h>
#include <zeus/log.h>
...
private:
    ...
    Thread *thread_;
    bool running_ ZEUS_TSA_GUARDED_BY(mutex_);
    pid_t tid_;
...
bool Thread::wait(utils::duration duration)
{
...

    {
        ...
        auto isRunning = ([&]() ZEUS_TSA_REQUIRES(data_->mutex_) {
